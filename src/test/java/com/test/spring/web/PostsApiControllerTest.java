package com.test.spring.web;import com.fasterxml.jackson.databind.ObjectMapper;
...
public class PostsApiControllerTest {
    ...
    @Before // 테스트 시작 전 mockmvc 인스턴스 생성
    public void setup() {
        mvc = MockMvcBuilders
    ...
    @Test
    @WithMockUser(roles="USER") // 인증된 모의 사용자 만들어서 사용
